...
import HowToUse from "./components/resources/howToUse";
...
function Dashboard() {
  ...
  return (
    <>
      <div className="flex h-screen bg-secondary-lighter overflow-hidden relative">
        <SidebarNav
          collapsed={collapsed}
          onToggleCollapse={() => setCollapsed(!collapsed)}
          onHowToClick={() => setShowHowToModal(true)}
      ...
      {showHowToModal && <HowToUse onClose={() => setShowHowToModal(false)} />}
